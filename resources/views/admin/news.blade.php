        ...
        <div class="col-lg-12">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="d-flex align-items-center">
                        <span class="badge bg-primary rounded-pill px-3 py-2">
                            <i class="fas fa-list mr-1"></i> Semua Berita
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="card setting-card mb-4">
                <div class="card-header setting-header text-white d-flex justify-content-between align-items-center flex-wrap">
                    <p class="mb-2 mb-md-0">Kelola semua berita yang tersedia</p>
                    <div>
                       <button onclick="window.location='{{ route('news.create') }}'" class="btn btn-light btn-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-label="Kategori">
                                        <span class="badge rounded-pill bg-{{ $item->category_color }}">
                                            {{ $item->category }}
                                        </span>
                                    </td>
                                    <td data-label="Penulis">{{ $item->author }}</td>
                                    <td data-label="Dilihat">{{ $item->views }}</td>
                                    <td data-label="Aksi">
                                        <div class="d-flex gap-2 justify-content-center flex-wrap">
                                            ...
                                            <button 
                                            onclick="window.location='{{ route('news.edit', $item) }}'" 
    ...
    $(document).ready(function() {
        var table = $('#newsTable').DataTable({
            ...
            initComplete: function() {
                this.api().buttons().container().appendTo('#newsTable_wrapper .col-md-6:eq(0)');
            },
            columnDefs: [
                { responsivePriority: 1, targets: 0 }, // No
                { responsivePriority: 2, targets: -1 }, // Aksi
                { responsivePriority: 3, targets: 1 }, // Judul
                { responsivePriority: 4, targets: 2 }, // Kategori
                { responsivePriority: 5, targets: 3 }, // Penulis
                { responsivePriority: 6, targets: 4 }, // Dilihat
                { 
