        ...
        <div class="col-lg-12">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <span class="badge bg-primary rounded-pill px-3 py-2">
                            <i class="fas fa-info-circle mr-1"></i> Formulir Edit Berita
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-primary text-white">
                    <h6 class="m-0 font-weight-bold">Edit data berita</h6>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('news.update', $news) }}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="excerpt" class="form-control @error('excerpt') is-invalid @enderror" 
                                              name="excerpt" rows="3" required>{{ old('excerpt', $news->excerpt) }}</textarea>
                                    @error('excerpt')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('category_color') is-invalid @enderror" 
                                        ...
                                        @foreach($categoryColors as $value => $label)
                                            <option value="{{ $value }}" @selected(old('category_color', $news->category_color) == $value)>{{ $label }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group mb-4">
                            ...
                            @if($news->image)
                                <div class="mt-3">
                                    <img src="{{ asset('storage/berita/' . $news->image) }}" alt="Current Image" class="img-thumbnail" style="max-height: 200px;">
