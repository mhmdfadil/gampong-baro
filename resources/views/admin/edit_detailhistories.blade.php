        ...
        <div class="col-lg-12">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="mb-3">
                        <h4 class="m-0 font-weight-bold text-primary">
                            <i class="fas fa-edit"></i> Edit Rincian Sejarah: {{ $detailhistory->year }}
                        </h4>
                    </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-primary text-white">
                    <h6 class="m-0 font-weight-bold">Edit data sejarah</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('detailhistories.update', $detailhistory->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('year') is-invalid @enderror" 
                                           ...
                                           value="{{ old('year', $detailhistory->year) }}">
                                    @error('year')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('bg_year') is-invalid @enderror" 
                                        ...
                                        @foreach($bgColors as $value => $label)
                                            <option value="{{ $value }}" 
                                                {{ old('bg_year', $detailhistory->bg_year) == $value ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                   ...
                                   value="{{ old('title', $detailhistory->title) }}">
                            @error('title')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea class="form-control @error('description_singkat') is-invalid @enderror" 
                                      ...
                                      rows="4" required>{{ old('description_singkat', $detailhistory->description_singkat) }}</textarea>
