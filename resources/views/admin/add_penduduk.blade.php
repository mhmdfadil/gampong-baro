        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-primary text-white">
                    <h6 class="m-0 font-weight-bold">Isi data penduduk baru</h6>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="no_kk" type="text" class="form-control @error('no_kk') is-invalid @enderror" 
                                           name="no_kk" value="{{ old('no_kk') }}" placeholder="Masukkan nomor KK">
                                    @error('no_kk')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="dusun" type="text" class="form-control @error('dusun') is-invalid @enderror" 
                                           name="dusun" value="{{ old('dusun') }}" placeholder="Masukkan nama dusun" required>
                                    @error('dusun')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="status_keluarga" class="form-select @error('status_keluarga') is-invalid @enderror" 
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="agama" class="form-select @error('agama') is-invalid @enderror" 
                                            name="agama" required>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="status_perkawinan" class="form-select @error('status_perkawinan') is-invalid @enderror" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="pendidikan_terakhir" class="form-select @error('pendidikan_terakhir') is-invalid @enderror" 
                                        ...
                                        <option value="Pascasarjana" {{ old('pendidikan_terakhir') == 'Pascasarjana' ? 'selected' : '' }}>Pascasarjana</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="pekerjaan" class="form-select @error('pekerjaan') is-invalid @enderror" 
