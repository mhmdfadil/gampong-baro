        ...
        <div class="col-lg-12">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="mb-3">
                        <h4 class="m-0 font-weight-bold text-primary">
                            <i class="fas fa-plus-circle"></i> Tambah Misi Baru
                        </h4>
                    </div>
                    <div class="d-flex align-items-center">
                        <span class="badge bg-primary rounded-pill px-3 py-2">
                            <i class="fas fa-info-circle mr-1"></i> Formulir Misi
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-primary text-white">
                    <h6 class="m-0 font-weight-bold">Isi data misi</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('missions.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('index') is-invalid @enderror" 
                                           ...
                                           value="{{ old('index') }}" placeholder="Masukkan nomor index">
                                    @error('index')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('bg_index') is-invalid @enderror" 
                                        ...
                                        @foreach($bgOptions as $value => $label)
                                            <option value="{{ $value }}" {{ old('bg_index') == $value ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea class="form-control @error('misi') is-invalid @enderror" 
                                      id="misi" name="misi" 
                                      rows="4" required placeholder="Masukkan teks misi">{{ old('misi') }}</textarea>
                            @error('misi')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
